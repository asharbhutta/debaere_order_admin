<div class="sidebar pe-4 pb-3">
    ...
    <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{ route('admin_holidayDates') }}" class="nav-item nav-link  {{  strpos(request()->route()->getName(),'holidayDates')!== false ? 'active' : ' ' }}"><i class="fa fa-book m-2"></i>Holiday Dates</a>
